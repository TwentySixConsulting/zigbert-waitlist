...
const CASES = [
  ...
  ["how much does it cost?", "How much does Zigbert cost"],
  ["what's the price", "How much does Zigbert cost"],
  ["is it expensive", "How much does Zigbert cost"],
  ["how much is a subscription", "How much does Zigbert cost"],
  ["whats the cost per month", "How much does Zigbert cost"],
  ["do i have to pay yearly", "How much does Zigbert cost"],
  ["is there a minimum contract", "How much does Zigbert cost"],
  ["is it available yet", "Is Zigbert available now"],
  ["when can i start using it", "Is Zigbert available now"],
  ["is it live yet", "Is Zigbert available now"],
  ["is there a free trial", "Can I see a demo of Zigbert"],
  ["can i get a demo", "Can I see a demo of Zigbert"],
  ["can i see a sample dashboard", "Can I see a demo of Zigbert"],
  ["how do i get started", "How do I get started with Zigbert"],
  ["how do i sign up", "How do I get started with Zigbert"],
  ["sign me up", "How do I get started with Zigbert"],
